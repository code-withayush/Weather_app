...
const favoriteCities = [
  { name: "New Delhi", temp: "28°C", weather: "Sunny ☀️", humidity: "45%" },
  { name: "London", temp: "18°C", weather: "Cloudy ☁️", humidity: "65%" },
  { name: "Tokyo", temp: "24°C", weather: "Rainy 🌧️", humidity: "80%" },
  { name: "Sydney", temp: "22°C", weather: "Windy 🌬️", humidity: "50%" },
];
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-700 via-purple-700 to-pink-700 p-6">
      <div className="text-center mb-12">
        ...
        <p className="text-white mt-4 text-lg md:text-xl">
          Monitor your favorite cities and their current weather conditions.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {favoriteCities.map((city, index) => (
          ...
          >
            ...
            <p className="text-white opacity-80 mb-1 relative z-10">{city.weather}</p>
            <p className="text-white opacity-70 relative z-10">Humidity: {city.humidity}</p>
          </div>
        ))}
      </div>
